...
Route::get('/manager/login', 'ManageController@login')->name('manage.action.login');
...
Route::get('/app/conference/{conferenceID}/settings', 'ConferenceSettingsController@home')->name('app.conference.settings.home');
